...
# -*- coding: utf-8 -*-
"""
Simplified Flask Web Application for Screenshot Search Tool Demo
This version works without heavy AI dependencies for basic demonstration
"""
...
if __name__ == '__main__':
    print("\nSimple Screenshot Search Demo")
    print("=" * 40)
    print("This is a simplified version for demonstration.")
    print("For full AI-powered search, install the complete dependencies.")
